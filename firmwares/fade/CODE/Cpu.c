...
loop:
    ...
    /*
     * Delay
     *   - requested                  : 100 us @ 16.7424MHz,
     *   - possible                   : 1674 c, 99985.67 ns, delta -14.33 ns
     *   - without removable overhead : 1666 c, 99507.84 ns
     */
    pshh                               /* (2 c: 119.46 ns) backup H */
    pshx                               /* (2 c: 119.46 ns) backup X */
    ldhx #$00CE                        /* (3 c: 179.19 ns) number of iterations */
label0:
    aix #-1                            /* (2 c: 119.46 ns) decrement H:X */
    cphx #0                            /* (3 c: 179.19 ns) compare it to zero */
    bne label0                         /* (3 c: 179.19 ns) repeat 206x */
    pulx                               /* (3 c: 179.19 ns) restore X */
    pulh                               /* (3 c: 179.19 ns) restore H */
    nop                                /* (1 c: 59.73 ns) wait for 1 c */
    nop                                /* (1 c: 59.73 ns) wait for 1 c */
    nop                                /* (1 c: 59.73 ns) wait for 1 c */
    nop                                /* (1 c: 59.73 ns) wait for 1 c */
    nop                                /* (1 c: 59.73 ns) wait for 1 c */
...
void _EntryPoint(void)
{
  ...
  setReg8(ICSC1, 0x04);                /* Initialization of the ICS control register 1 */ 
...
void PE_low_level_init(void)
{
  ...
  /* PTAD: PTAD1=0 */
  clrReg8Bits(PTAD, 0x02);              
  /* PTADD: PTADD3=0,PTADD1=1 */
  clrSetReg8Bits(PTADD, 0x08, 0x02);    
  /* PTAPE: PTAPE3=0 */
  clrReg8Bits(PTAPE, 0x08);             
