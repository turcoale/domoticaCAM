...
#define PWM1_PERIOD_VALUE              0xFFFF /* Initial period value in ticks of the timer in high speed mode */
#define PWM1_PERIOD_VALUE_HIGH         0xFFFF /* Period value in ticks of the timer in high speed mode */
