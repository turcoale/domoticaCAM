...
#define CPU_BUS_CLK_HZ              0x00FF7800UL /* Initial value of the bus clock frequency in Hz */

#define CPU_INSTR_CLK_HZ            0x00FF7800UL /* Initial value of the instruction clock frequency in Hz */
...
#define CPU_PARTNUM_MC9S08SH8MPJ       /* Part number of the selected cpu */
